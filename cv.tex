...
\par{
    ...
    \large \textsc{Kandidaat Enterprise Architect Data Delen bij EDSN}\par
    \small \textsc{\displayage{1990-20-09}}\par
...
\begin{longtable}{p{3.4cm}|p{14.1cm}}
  \joblogcurrent{Data Professional}{Dewpoint Advisory}{Amsterdam, NL}{2020-08-19}{%
  Enterprise architectuur, solution architectuur, cloud engineering, security engineering, data privacy, project management, change management:
  \begin{itemize}
    \item Data strategie, data governance, data management, e.g. data democratization en data mesh
    \item Public cloud governance, architectuur en implementaties, e.g. Microsoft Azure en Google Cloud Platform
    \item Klantportalen voor data delen: markt consultaties, evaluaties, ontwerpen, inrichten en uitrollen
  \end{itemize}
  }

  \joblog{Data \& Analytics Consultant}{Avanade}{Utrecht, NL}{2017-04-01}{2020-03-31}{%
  Solution architect, data engineer, data scientist, data analist, business analist:
    \item Data strategie, data governance, data management, e.g. data democratization en data mesh
    \item Public cloud governance, architectuur en implementaties, e.g. Microsoft Azure en Google Cloud Platform
    \item Klantportalen voor data delen: markt consultaties, evaluaties, ontwerpen, inrichten en uitrollen
  leveraging solutions from the Microsoft ecosystem such as Azure, SQL Server, SSIS and Power BI. 
  }{}
